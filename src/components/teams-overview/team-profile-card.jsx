            ...
            <div className='w-full h-full flex flex-col gap-4'>
                ...
                <div className='w-full flex items-center justify-start gap-8'>
                    <div className='flex items-center gap-2 text-gray-400 cursor-pointer group hover:text-white transition-all duration-300'>
                        ...
                        <p className='text-gray-400 text-sm group-hover:text-white transition-all duration-300'>Back</p>
                    </div>
                    {/* team profile  */}
                    <div className='flex items-center gap-2'>
                        ...
                        <div className='flex flex-col'>
                            ...
                            <p className='text-blue-700 text-xs'>Coach : Coach Saleh</p>
                        </div>
                    </div>
                </div>
                ...
                <div className='w-full grid grid-cols-2 sm:grid-cols-4 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-2'>
                    ...
                    <div className='flex items-center gap-2 text-sm text-gray-400 border border-gray-400/20 rounded-full px-3 py-1'>
                        ...
                        <p className='text-gray-400'>Players : <span className='text-gray-200'>18</span></p>
                    </div>

                    {/* avg fitness  */}
                    <div className='flex items-center gap-2 text-sm text-gray-400 border border-gray-400/20 rounded-full px-3 py-1'>
                        <FaHeart className='size-4 text-red-400' />
                        <p className='text-gray-400'>Avg Fitness : <span className='text-gray-200'>70%</span></p>
                    </div>
                    ...
                    <div className='flex items-center gap-2 text-sm text-gray-400 border border-gray-400/20 rounded-full px-3 py-1'>
                        ...
                        <p className='text-gray-400'>Win Rate : <span className='text-gray-200'>67%</span></p>
                    </div>
                    {/* avg form  */}
                    <div className='flex items-center gap-2 text-sm text-gray-400 border border-gray-400/20 rounded-full px-3 py-1'>
                        <BarChart className='size-4 text-yellow-400' />
                        <p className='text-gray-400'>Avg Form : <span className='text-gray-200'>6.7</span></p>
                    </div>
                </div>
